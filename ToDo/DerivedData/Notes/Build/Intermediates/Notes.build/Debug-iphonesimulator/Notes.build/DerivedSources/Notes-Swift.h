...
SWIFT_CLASS("_TtC5Notes11AppDelegate")
...
SWIFT_CLASS("_TtC5Notes24NotesTableViewController")
@interface NotesTableViewController : UITableViewController
@property (nonatomic, copy) NSArray * __nonnull notes;
- (void)viewDidLoad;
- (IBAction)addButton:(id __nonnull)sender;
- (void)saveNotes:(NSString * __nonnull)note;
